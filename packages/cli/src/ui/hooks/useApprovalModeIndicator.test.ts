...
import { Config, ApprovalMode } from '@bare-ai/core';
import type { Config as ActualConfigType } from '@bare-ai/core';
...
vi.mock('@bare-ai/core', async () => {
  const actualServerModule = await vi.importActual('@bare-ai/core');
  return {
    ...actualServerModule,
    Config: vi.fn(),
