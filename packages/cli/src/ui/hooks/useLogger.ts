...
import type { Storage } from '@bare-ai/core';
import { sessionId, Logger } from '@bare-ai/core';
...
export const useLogger = (storage: Storage) => {
  ...
  useEffect(() => {
     ...
     * time from launch to see the bare-ai-cli prompt and it's better to not save
