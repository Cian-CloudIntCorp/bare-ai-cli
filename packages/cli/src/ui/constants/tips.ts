...
export const INFORMATIVE_TIPS = [
  ...
  'Show Bare AI CLI status in the terminal window title (/settings)…',
  ...
  'Create a project-specific BARE_AI.md file with /init…',
  ...
  'Reload instructional context from BARE_AI.md files with /memory reload…',
  'List the paths of the BARE_AI.md files in use with /memory list…',
