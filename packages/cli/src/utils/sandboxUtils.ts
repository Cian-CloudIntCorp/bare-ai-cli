...
import { debugLogger, BARE_AI_DIR } from '@bare-ai/core';

export const LOCAL_DEV_SANDBOX_IMAGE_NAME = 'bare-ai-cli-sandbox';
export const SANDBOX_NETWORK_NAME = 'bare-ai-cli-sandbox';
export const SANDBOX_PROXY_NAME = 'bare-ai-cli-sandbox-proxy';
