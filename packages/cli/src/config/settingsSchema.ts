  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show Bare AI CLI model thoughts in the terminal window title during the working phase',
        showInDialog: true,
      },
      dynamicWindowTitle: {
        type: 'boolean',
      ...
      showHomeDirectoryWarning: {
        ...
        default: true,
        description:
          'Show a warning when running Bare AI CLI in the home directory.',
        showInDialog: true,
      },
      ...
      voice: {
        ...
        properties: {
          backend: {
            ...
            requiresRestart: false,
            default: 'gemini-live',
            description: 'Voice backend to use.',
            showInDialog: false,
          },
          stopGracePeriodMs: {
            type: 'number',
            ...
            requiresRestart: false,
            default: 1500,
            description: 'Grace period in ms before stopping voice.',
            showInDialog: false,
          },
          activationMode: {
            type: 'string',
      ...
      gemmaModelRouter: {
        ...
        properties: {
          autoStartServer: {
            ...
            requiresRestart: true,
            default: false,
            description: 'Auto start the Gemma model router server.',
            showInDialog: false,
          },
          binaryPath: {
            type: 'string',
            ...
            requiresRestart: true,
            default: undefined,
            description: 'Path to the Gemma model router binary.',
            showInDialog: false,
          },
          enabled: {
            type: 'boolean',
            ...
            default: false,
            description:
              'Enable the Gemma Model Router (experimental). Requires a local endpoint serving Gemma via the Bare AI API using LiteRT-LM shim.',
            showInDialog: false,
          },
          classifier: {
            type: 'object',
...
> = {
  MCPServerConfig: {
    ...
    properties: {
      ...
      extension: {
        type: 'object',
        description:
          'Metadata describing the Bare AI CLI extension that owns this MCP server.',
  ...
  TelemetrySettings: {
    type: 'object',
    description: 'Telemetry configuration for Bare AI CLI.',
    additionalProperties: false,
    properties: {
      enabled: {
        type: 'boolean',
  ...
  CustomTheme: {
    type: 'object',
    description:
      'Custom theme definition used for styling Bare AI CLI output. Colors are provided as hex strings or named ANSI colors.',
    additionalProperties: false,
    properties: {
      type: {
        type: 'string',
