...
import { debugLogger, type SkillDefinition } from '@bare-ai/core';
...
async function extensionConsentString(
  ...
  if (sanitizedConfig.contextFileName) {
    output.push(
      `This extension will append info to your bare-ai.md context using ${sanitizedConfig.contextFileName}`,
    );
  }
