...
## Step 6: Add a custom `BARE_AI.md`

Provide persistent context to the model by adding a `BARE_AI.md` file to your
extension. This is useful for setting behavior or providing essential tool
information.

1.  Create a file named `BARE_AI.md` in the root of your extension directory:
...
Restart Gemini CLI. The model now has the context from your `BARE_AI.md` file in
